    ...
    {event.blocks?.some((b) => b.type === "rsvp") && (
      <section style={{ marginTop: "2rem" }}>
        ...
        <form
          ...
          style={{ maxWidth: "400px", display: "flex", flexDirection: "column", gap: "0.5rem" }}
        >
          <input
            type="text"
            required
          ...
          {rsvpDone && (
            <p style={{ color: "lightgreen" }}>Grazie, abbiamo registrato la tua risposta ✅</p>
          )}
          {rsvpError && (
            <p style={{ color: "salmon" }}>{rsvpError}</p>
          )}
        </form>
      </section>
    )}
